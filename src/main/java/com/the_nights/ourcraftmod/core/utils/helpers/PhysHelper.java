...
////			//Main.INSTANCE.messagePipeline.sendToAllAround(msg, new TargetPoint(world.provider.dimensionId, explosion.explosionX, explosion.explosionY, explosion.explosionZ, 64D));
////		}
//	}
	
	public static void knockBack(Entity entityliving, Entity attacker, float knockback)
	{
...
//		kbMotionX = kbMotionY = kbMotionZ = 0D;
	...
	public static void prepareKnockbackOnEntity(Entity attacker, Entity entity)
	{
